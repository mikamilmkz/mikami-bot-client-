...
SEARCH_CHANNEL_ID = int(os.getenv("SEARCH_CHANNEL_ID", "1508901038222999592"))
RESULTS_CHANNEL_ID = int(os.getenv("RESULTS_CHANNEL_ID", "1508902316479221891"))

BASE_URL = os.getenv("BASE_URL", "https://mikami-justice.onrender.com")
